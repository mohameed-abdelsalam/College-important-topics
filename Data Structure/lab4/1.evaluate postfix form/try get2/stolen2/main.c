...
#define MAXSTACK 10000 /* for max size of stack */
#define POSTFIXSIZE 10000 /* define max number of charcters in postfix expression */
...
ch - '0' is used for getting digit rather than ASCII code of digit */
            ...
            push(ch - '0');    //to get true decimal value of the digit
        }
